...
export function VideoInputForm(props: VideoInputFormProps) {
    ...
    async function convertVideoToAudio(video: File) {
        ...
        const audiFileBLob = new Blob([data], {
            type: 'audio/mpeg'
        });
        const audioFile = new File([audiFileBLob], 'audio.mp3', {
            type: 'audio/mpeg',
        });
        ...
        <form onSubmit={handleUploadVideo} className='space-y-6'>
            ...
            <div className='space-y-2'>
                ...
                <Textarea
                    ...
                    placeholder='Inclua palavra-chave mencionadas no vídeo separada por virgula (,)'>
                </Textarea>
            </div>
