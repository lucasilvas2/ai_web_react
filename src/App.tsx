    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className='flex-1 p-6 flex gap-6'>
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <p className='text-sm text-muted-foreground'>Lembre-se: você pode utilizar a varável <code className='text-violet-400'>{'{transcription}'}</code> no seu prompt para adicionar o conteúdo do vídeo selecionado.</p>
        </div>
        <aside className='w-80 space-y-6'>
          <form className='space-y-6'>
            ...
            <div className='space-y-2'>
              ...
              <Textarea id="transcription_prompt" className='h-20 leading-relaxed resize-none'
                placeholder='Inclua palavra-chave mencionadas no vídeo separada por virgula (,)'></Textarea>
            </div>
          ...
          <form className='space-y-6'>
            ...
            <div className='space-y-4'>
              ...
              <span className='block text-xs text-muted-foreground italic leading-relaxed'>Valores mais altos tendem a deixar o resultado mais criativo mais com possíveis erros.</span>
            </div>
